...
<div id="hero" style="background-image: url(img/work/young/hero.jpg)">
  ...
  <div class="contain middle">
    ...
    <p>Young Consulting Group offers strategic consulting and brand development to Nonprofit Organizations.</p>
  </div>
</div>
...
<article>
  <div class="contain">
    ...
    <div id="imac">
      ...
      <div class="screen"><img src="img/work/young/window.jpg" alt="Young Consulting Group's homepage"></div>
    </div>
  ...
  <div id="slug">
    ...
    <div id="slides">
    <img src="img/work/young/gallery/1.jpg" alt="Responsive on every device">
    <img src="img/work/young/gallery/2.jpg" alt="Dan Young Bio on an iPpad">
    <img src="img/work/young/gallery/3.jpg" alt="The e-commerce Site">
